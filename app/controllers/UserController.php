...
class UserController {
    ...
    public function formCreate() {
        $this->loadView('formCreate', ['title' => 'Welcome to the User Page!']);
    }
    public function formSubmit() {
        ...
        $result = $this->userModel->formSubmit($formTitle,$formFields);
        echo json_encode($result); // Return the model's response directly
        die();
    }
    public function responseCreateView() {
        
        $this->loadView('responseCreateView', ['title' => 'Welcome to the User Page!']);

    }

    public function responseCreate() {
        $result = $this->userModel->getFormDetails(7);
        ...
        if (isset($result['error'])) {
            ...
            echo json_encode(['success' => true, 'form' => $result['form'], 'fields' => $result['fields']]);
        }
    }
